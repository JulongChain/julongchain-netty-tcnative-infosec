                                                         ...
                                                         jstring password)
{
	...
	// encrypt certificate
    if ((penckey = load_pem_key_bio(c->password, enc_key_bio)) == NULL) {
        ERR_error_string(ERR_get_error(), err);
        ERR_clear_error();
    ...
    if ((xenccert = load_pem_cert_bio(c->password, enc_cert_bio)) == NULL) {
        ERR_error_string(ERR_get_error(), err);
        ERR_clear_error();
	...
	// signature certificate
    if ((psignkey = load_pem_key_bio(c->password, sign_key_bio)) == NULL) {
        ERR_error_string(ERR_get_error(), err);
        ERR_clear_error();
    ...
    if ((xsigncert = load_pem_cert_bio(c->password, sign_cert_bio)) == NULL) {
        ERR_error_string(ERR_get_error(), err);
        ERR_clear_error();
